<?php
Route::get('index',  'SmFrontendController@home');
Route::get('signup',  'SmFrontendController@signup');
Route::get('signin',  'SmFrontendController@signin');
...
Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
    ...
    Route::get('ledger-summary', 'SmStudentFeesController@ledgeSummary');
    Route::post('ledger-summary', 'SmStudentFeesController@ledgeSummarySearch');
    ...
    Route::resource('add-fees', 'SmStudentFeesController');
    Route::get('fees-money-receipt/{id}', 'SmStudentFeesController@feesMoneyReceipt');
    ...
    Route::post('tabulation-sheet/print', 'SmReportController@tabulationSheetReportPrint');
     ...
     Route::get('tabulation-sheet-empty', 'SmReportController@tabulationSheetEmpty');
     Route::post('tabulation-sheet-empty', 'SmReportController@tabulationSheetEmptySearch');
     Route::post('tabulation-sheet-empty/print', 'SmReportController@tabulationSheetEmptyPrint');
