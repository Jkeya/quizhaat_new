          ...
          <ul>
            <li data-transition="fade" data-thumb=""><img src="style/images/dummy.png" style="background:transparent" alt="" />
              <div class="tp-caption" 
                   ...
                   data-lazyload="" src="<?php echo e(asset('')); ?>public/web_assets/style/images/art/rocket1.png" 
              ...
              <div class="tp-caption" 
                   ...
                   data-responsive_offset="on" 
                   data-basealign="slide" style="z-index: 5;"><img 
                   data-lazyload="" src="<?php echo e(asset('')); ?>public/web_assets/style/images/art/rocket2.png" 
              ...
              <div class="tp-caption" 
                   ...
                   data-lazyload="" src="<?php echo e(asset('')); ?>public/web_assets/style/images/art/rocket3.png" 
              ...
              <div class="tp-caption" 
                   ...
                   data-responsive_offset="on" 
                   data-basealign="slide" style="z-index: 5;"><img 
                   data-lazyload="" src="<?php echo e(asset('')); ?>public/web_assets/style/images/art/rocket4.png" 
      ...
      <div class="container inner pt-100">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 order-lg-2">
            <figure><img src="#" srcset="<?php echo e(asset('')); ?>public/web_assets/style/images/concept/concept1.png 1x, <?php echo e(asset('')); ?>public/web_assets/style/images/concept/concept1@2x.png 2x" alt="" /></figure>
          </div>
          <!--/column -->
          <div class="space20 d-md-none"></div>
          <div class="space50 d-none d-md-block d-lg-none"></div>
