...
<html lang="zxx">
    ...
    ================================================== -->
        <!-- Vendor CSS -->
        <link href="<?php echo e(asset('public/web_assets/css/bootstrap.css')); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset('public/web_assets/css/all.min.css')); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset('public/web_assets/css/v4-shims.min.css')); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset('public/web_assets/css/simple-line-icons.css')); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset('public/web_assets/css/magnific-popup.css')); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset('public/web_assets/css/slick.css')); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset('public/web_assets/css/style-soccer.css')); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset('public/web_assets/css/custom.css')); ?>" rel="stylesheet" />
        <style type="text/css">
            .header-logo a{
    ...
    <body data-template="template-soccer">
        ...
        ================================================== --><!-- Header Mobile -->
            <div class="header-mobile clearfix" id="header-mobile">
                <div class="header-mobile__logo">
                    <a href="_soccer_index.html"><img src="<?php echo e(asset('web_assets/images/main_logo.png')); ?>" srcset="web_assets/images/soccer/logo@2x.png 2x" alt="Alchemists" class="header-mobile__logo-img" /></a>
                </div>
                    ...
                    <div class="container">
                        <div class="header__primary-inner">
                            ...
                            <div class="header-logo">
                                <a href="#"><!-- <img src="<?php echo e(asset('public/web_assets/images/main_logo.png')); ?>" srcset="web_assets/images/soccer/logo@2x.png 2x" alt="Alchemists" class="header-logo__img" /> -->
                                    QUIZHAAT
                                </a>
                            </div>
                ...
                <div class="pushy-panel__inner">
                    <header class="pushy-panel__header">
                        <div class="pushy-panel__logo">
                            <a href="#"><img src="<?php echo e(asset('web_assets/images/main_logo.png')); ?>" srcset="web_assets/images/soccer/logo@2x.png 2x" alt="Alchemists" /></a>
                        </div>
                    </header>
        ...
        <!-- Javascript Files
    ================================================== --><!-- Core JS -->
        <script src="<?php echo e(asset('public/web_assets/js/jquery.min.js')); ?>"></script>
        <script src="<?php echo e(asset('public/web_assets/js/jquery-migrate.min.js')); ?>"></script>
        <script src="<?php echo e(asset('public/web_assets/js/bootstrap.bundle.min.js')); ?>"></script>
        <script src="<?php echo e(asset('public/web_assets/js/core.js')); ?>"></script>
        <script src="<?php echo e(asset('public/web_assets/js/jquery.twitter.js')); ?>"></script>
        <script src="<?php echo e(asset('public/web_assets/js/init.js')); ?>"></script>
        <script src="<?php echo e(asset('public/web_assets/js/custom.js')); ?>"></script>
