                            ...
                            <div class="add-visitor">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('group') ? ' is-invalid' : '' }}" name="subject">
                                            <option data-display="Select Subject">Select Subject</option>
                                            @foreach($subjects as $subject)
                                                @if(isset($bank))
                                                <option value="{{$subject->id}}" {{$subject->id == $bank->subject_id? 'selected': ''}}>{{$subject->subject_name}}</option>
                                                @else
                                                <option value="{{$subject->id}}" {{old('subject')!=''? (old('subject') == $subject->id? 'selected':''):''}} >{{$subject->subject_name}}</option>
                                                @endif
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            <input class="primary-input form-control{{ $errors->has('marks') ? ' is-invalid' : '' }}" type="number" name="marks" value="2">
                                            <label>Point *</label>
                                ...
                                <div class="multiple-options" id="{{isset($multiple_options)? "": 'multiple-options'}}">
                                    ...
                                    @endphp
                                   <!--  @php  echo "<pre>"; print_r($multiple_options); @endphp -->
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">@lang('lang.question_bank') @lang('lang.list') 
                                ({{ count($banks)}})
                            </h3>
                        </div>
                    </div>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{($bank->questionSubject)!=''?$bank->questionSubject->subject_name:''}}</td>
