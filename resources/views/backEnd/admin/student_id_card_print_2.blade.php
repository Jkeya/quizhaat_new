    ...
    <table style="height: 800px">
        <tr>
           ...
           <table cellpadding="0" cellspacing="0" border="0" width="280" height="321" align="center" style="margin-top: 55px;">
            ...
            <table>
                <tr>
                    <td> <img src="{{asset($id_card->logo)}}" width="20%" 
              ></td>
              <td>
                  <h3 style="padding: 5px; text-align: center; margin-bottom: 20px;  color: #fff; font-family: 'PT Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; margin-left: 25px; ">Belchuci Govt College<br>Since 1970</h3>
              </td>
                </tr>
            </table>
        ...
        <tr >
            <td colspan="3" style="text-align: center;   border-right: 1px solid #ddd; border-left: 1px solid #ddd;">
                <img src="{{asset($student->student_photo)}}" alt="" style="width: 50%; margin-top: 5px;">
            </td>
        </tr>
        ...
        @endif
                       <!--  @if($id_card->admission_no == 1)
                        ...
                        @endif -->
                        <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">Roll No.</td>
                            
                            <td style="text-align: right; margin-right: 40px !important; border-right: 1px solid #ddd">{{$student->roll_no}}</td>
                        </tr>
                        @if($id_card->class == 1)
                        <tr >
                        ...
                        @endif
                       <!--  <tr >
                            <td colspan="2" style="padding-left: 20px; border-left: 1px solid #ddd">Group</td>
                            
                            <td style="text-align: right; margin-right: 40px !important; border-right: 1px solid #ddd"></td>
                        </tr> -->
                        ...
                        <tr >
                            <td colspan="3" style="text-align: center; padding-top: 20px; border-bottom: 1px solid #ddd; border-right: 1px solid #ddd; border-left: 1px solid #ddd;">
                                ...
                                <p>ID Card Validity: 31th December, 2022</p>
