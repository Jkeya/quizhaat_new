            ...
            <a href="#" class="d-block">
                <div class="white-box single-summery">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h3>Answers Today</h3>
                            <p class="mb-0">Total Answers Today</p>
                        </div>
                        <h1 class="gradient-color2">
                ...
                <a href="#" class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3>Total Cost</h3>
                                <p class="mb-0">Total Cost in this Month</p>
                            </div>
                            <h1 class="gradient-color2">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1>${{number_format($m_total_income)}}</h1>
                                <p>@lang('lang.total_income')</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1>${{number_format($m_total_expense)}}</h1>
                                <p>@lang('lang.total_expenses')</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1>${{number_format($m_total_income - $m_total_expense)}}</h1>
            ...
            <div class="col-lg-12">
                <div class="white-box" id="areaChartDiv">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1>${{number_format($y_total_income)}}</h1>
                                <p>@lang('lang.total_income')</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1>${{number_format($y_total_expense)}}</h1>
                                <p>@lang('lang.total_expenses')</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="text-center">
                                <h1>${{number_format($y_total_income - $y_total_expense)}}</h1>
                                <p>@lang('lang.total_profit')</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
