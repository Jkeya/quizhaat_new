   ...
   @include('web.partials.header')
    ...
    <div class="wrapper light-wrapper">
      ...
      <!--       <h2 class="section-title text-center">Drop Us a Line</h2>
            ...
            <div class="space30"></div>
            <form id="contact-form" method="post" action="{{ route('signup') }}">
              @csrf
              ...
              <div class="row">
                ...
                <div class="form-row">
                  <div class="col-md-12">
                    <p class="text-muted text-center">Already a member ? Then <a href="{{route('signin')}}"><strong style="color: #000000;">Login</strong></a> Now</p>
                  </div>
                </div>
              </div>
                </div>
