   ...
   @include('web.partials.header')
    ...
    <div class="wrapper light-wrapper">
      ...
      <!--       <h2 class="section-title text-center">Drop Us a Line</h2>
            ...
            <div class="space30"></div>
            <form id="contact-form" method="POST" action="{{ route('signin') }}">
              @csrf
              ...
              <div class="row">
                ...
                <div class="form-row">
                  <div class="col-md-12">
                    <p class="text-muted text-center">Do not have any account ? Then <a href="{{route('signup')}}"><strong style="color: #000000;">Signup</strong></a> Now</p>
                  </div>
                </div>
              </div>
                </div>
