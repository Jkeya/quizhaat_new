  ...
  <div class="content-wrapper">
   @include('web.partials.header')
    ...
    <div class="offcanvas-info inverse-text">
      ...
      <a href="index.html"><img src="#" srcset="{{asset('')}}public/web_assets/style/images/logo-light.png 1x, {{asset('')}}public/web_assets/style/images/logo-light@2x.png 2x" alt="" /></a>
        ...
        <div class="row counter">
          <div class="col-md-6 col-lg-3 text-center">
            <div class="box bg-white shadow">
              <div class="icon icon-svg mb-20"><img src="{{asset('')}}public/web_assets/style/images/icons/hs-check.png" alt="" /></div>
          ...
          <div class="col-md-6 col-lg-3 text-center">
            <div class="box bg-white shadow">
              <div class="icon icon-svg mb-20"><img src="{{asset('')}}public/web_assets/style/images/icons/st-handshake.png" alt="" /></div>
          ...
          <div class="col-md-6 col-lg-3 text-center">
            <div class="box bg-white shadow">
              <div class="icon icon-svg mb-20"><img src="{{asset('')}}public/web_assets/style/images/icons/sm-develop.png" alt="" /></div>
          ...
          <div class="col-md-6 col-lg-3 text-center">
            <div class="box bg-white shadow">
              <div class="icon icon-svg mb-20"><img src="{{asset('')}}public/web_assets/style/images/icons/ms-medal.png" alt="" /></div>
