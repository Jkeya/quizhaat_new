...
class SmExaminationController extends Controller
{
    ...
    public function markSheetReportStudentSearch(Request $request)
    {
        ...
        return view('backEnd.reports.mark_sheet_report_student', compact('exam_types', 'classes', 'studentDetails', 'exams', 'classes', 'marks_register', 'subjects', 'class', 'section', 'exam_detail', 'grades', 'exam_id', 'class_id', 'student_detail','input', 'distributed_marks'), 'student_final_marks', 'total_marks_by_student');
    }
    ...
    public function markSheetReportStudentPrint(Request $request)
    {
        ...
        $student_id     =   $request->student;
        $exam_details     =   SmExamType::where('active_status', 1)->find($exam_type_id);
        $marks_grades     =   SmMarksGrade::where('active_status', 1)->get();
