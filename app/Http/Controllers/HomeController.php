...
class HomeController extends Controller
{
    ...
    if(Session::has('info_check')){
        ...
        return view('backEnd.dashboard', compact('totalStudents', 'totalTeachers', 'totalParents', 'totalStaffs', 'toDoLists', 'notices', 'toDoListsCompleteds', 'm_total_income', 'm_total_expense', 'y_total_income', 'y_total_expense', 'holidays', 'banks'));
    }
