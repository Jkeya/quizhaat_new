...
class SmQuestionBankController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backEnd.examination.question_bank', compact('banks', 'levels', 'groups', 'classes', 'sections', 'subjects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->question_type != 'M') {
            ...
            $online_question->subject_id= $request->subject;
    ...
    public function show($id)
    {
        try {
            ...
            $subjects = SmSubject::where('active_status', 1)->get();
            //return $bank;
            return view('backEnd.examination.question_bank', compact('subjects','levels', 'groups', 'banks', 'bank', 'classes', 'sections'));
        } catch (\Exception $e) {
            Toastr::error('Operation Failed', 'Failed');
            return redirect()->back();
        }
