...
//tabulationSheetReportPrint
    public function tabulationSheetReportPrint(Request $request){
        ...
        $pdf = PDF::loadView('backEnd.reports.tabulation_sheet_report_print',
            [
    ...
    public function tabulationSheetEmpty(Request $request){
        $exam_types = SmExamType::where('active_status', 1)->get();
        $classes = SmClass::where('active_status', 1)->get();
        ...
        return view('backEnd.reports.tabulation_sheet_empty', compact('exam_types', 'classes'));
    }

    public function tabulationSheetEmptySearch(Request $request){
        ...
        return view('backEnd.reports.tabulation_sheet_empty',
            compact('exam_types', 'classes','marks','subjects', 'exam_term_id','class_id','section_id','class_name','section_name','students','student_id','tabulation_details'));

        
    }

     public function tabulationSheetEmptyPrint(Request $request){
        ...
        $pdf = PDF::loadView('backEnd.reports.tabulation_sheet_empty_print',
            [
                'exam_types'    => $exam_types,
                'classes'       => $classes,
                'marks'         => $marks,
